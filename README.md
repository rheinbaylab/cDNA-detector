...
`gene_model` can be a **hg19**/**hg38**/**mm10**/**hg19_nochr**/**hg38_nochr**/**mm39** gene model provided with this tool or gene model file generated by subcommand `cdna-detector prepare` (see above).
